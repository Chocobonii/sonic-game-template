...
#include "indra/llPrimitives/llParticles/llFog.h"
#include "indra/llWorld/llChunks.h"
#include "indra/llAudio/llSound.h"
/*
-----------------------------------------------
...
int main(int argc, char **argv){
  ...
  LL_Gemini_start();
  #ifdef CL_AUDIO
    LL_Sterm->LL_Termios_Log("Sound engine is enabled......");
    auto am = std::async(LL_Audio_Manager);
  #endif
