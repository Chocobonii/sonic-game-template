...
struct Model {                  // THIS STRUCTURE WILL STORE ALL INGAME MODELS
  double model_vtx[9][9000];    // SO WHENEVER WE NEED MULTIPLE
  double model_uvs[6][9000];    // OBJECTS WITH THE SAME MODEL
...
void LL_Model_Manager::LL_Model_Draw(int _Model_identifier){
    ...
    ll_Obj_Draw_Model(m_aux->model_vtx, m_aux->model_uvs, m_aux->vertex_numer, m_aux->_texturel);
