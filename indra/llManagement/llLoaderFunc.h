void LL_Load_Models(){
 ...
 // ----------------------------------------------------------------------------------------------------+
 LL_Models->LL_Model_Push_ls("Res/Models/tree.obj","Res/Textures/tree.bmp",512,512);               // 6 | TREE FOR THE GAME WORLD
 LL_Models->LL_Model_Push_ls("Res/Models/wood.obj","Res/Textures/wood.bmp",512,512);               // 7 | TREE FOR THE GAME WORLD
}
...
void LL_Load_Textures(){
    ...
    LL_WATER_TEXTURES = LL_Bmp_Load_Image("Res/Textures/water.bmp", 256, 256);
    // ------- SKYBOX LOADING FOR THE GAME ---------
    LL_Sterm->LL_Termios_Log("loading skybox...");
    LL_SKY_PX = LL_Bmp_Load_Image("Res/Textures/skybox/sky_px.bmp", 512, 512);
    LL_SKY_NX = LL_Bmp_Load_Image("Res/Textures/skybox/sky_nx.bmp", 512, 512);
    LL_SKY_PY = LL_Bmp_Load_Image("Res/Textures/skybox/sky_py.bmp", 512, 512);
    LL_SKY_NY = LL_Bmp_Load_Image("Res/Textures/skybox/sky_ny.bmp", 512, 512);
    LL_SKY_PZ = LL_Bmp_Load_Image("Res/Textures/skybox/sky_pz.bmp", 512, 512);
    LL_SKY_NZ = LL_Bmp_Load_Image("Res/Textures/skybox/sky_nz.bmp", 512, 512);
    // ----------------------------------------------
}